  ...
  try {
    if (update.message) {
      ...
      if (text.startsWith('/start')) {
        ...
        await saveUser(id, user);
        await send(id, `🏪 *سجل كمورّد جديد*\n\nأرسل رسالة واحدة تحتوي:\n1. اسم النشاط التجاري\n2. الدولة والمدينة\n3. المنتجات اللي تصدّرها\n4. رقم واتساب للتواصل\n5. رابط فيديو قصير (30-60 ثانية) يوري المزرعة/المصنع والمنتج — يرفع على YouTube (غير مدرج) أو Google Drive\n\n🎥 الفيديو يخليك تحصل على شارة "موثّق بالفيديو ✅" ويزيد ثقة المشترين فيك.\n\n📩 اكتبها كلها في رسالة واحدة وأرسلها الآن:`);
      }
