import { LayoutDashboard, ArrowLeftRight, Cpu, ShieldCheck, BookOpen, Wallet, ShoppingBag, LogIn } from 'lucide-react';
...
type TabType = 'landing' | 'dashboard' | 'trading' | 'mining' | 'wallet' | 'market' | 'guide' | 'pi-verify' | 'pi' | 'transparency' | 'airdrop' | 'staking' | 'analytics' | 'seller' | 'admin';
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex flex-col">
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-gray-950 via-gray-950/90 to-transparent pt-12">
          ...
          <p className="text-center text-xs text-gray-500 mt-2">Powered by Stellar + Pi Network 🌍</p>
        </div>
      </div>
    );
  }
