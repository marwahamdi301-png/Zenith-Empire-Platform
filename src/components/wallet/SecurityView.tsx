    ...
    <div className="space-y-6 animate-slide-in">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              Never share your secret keys. These are public addresses only. Always verify addresses before sending transactions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {wallets.map((wallet, index) => (
          <div key={wallet.address} className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-primary/50 transition-all" >
